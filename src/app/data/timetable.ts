...
export const TIMETABLE: TimetableEntry[] = [
  ...
  { artistName: "Gaudi + Don Letts + Daddy G",    scene: "Dragon Nest", style: "Dub / World" },
  { artistName: "Gaslamp Killer",                  scene: "Dragon Nest", style: "Hip-Hop / Bass" },
  { artistName: "Younger Brother",                 scene: "Dragon Nest", style: "Psybient",       legend: true },
  { artistName: "Ott",                             scene: "Dragon Nest", style: "Psydub",         legend: true },
  { artistName: "Felix Laband",                    scene: "Dragon Nest", style: "Electronic" },
  { artistName: "Red Snapper",                     scene: "Dragon Nest", style: "Trip-Hop" },
  { artistName: "Phil Hartnoll",                   scene: "Dragon Nest", style: "Electronic",     legend: true },
  { artistName: "Konono N°1",                      scene: "Dragon Nest", style: "Afrobeat" },
  { artistName: "My Baby",                         scene: "Dragon Nest", style: "Blues / Folk" },
  { artistName: "Wild Marmalade",                  scene: "Dragon Nest", style: "Tribal / World" },
  { artistName: "Brooklyn Gypsies",                scene: "Dragon Nest", style: "Folk / World" },
  { artistName: "Mitsoura",                        scene: "Dragon Nest", style: "Folk / World" },
  { artistName: "Chicha Libre",                    scene: "Dragon Nest", style: "Cumbia / World" },
  { artistName: "Dubsahara meets Vlastur",         scene: "Dragon Nest", style: "Dub / World" },
  { artistName: "Óperentzia",                      scene: "Dragon Nest", style: "Folk / World" },
  { artistName: "Collignon",                       scene: "Dragon Nest", style: "Jazz / Cabaret" },
  { artistName: "Noura Mint Seymali",              scene: "Dragon Nest", style: "Mauritanian Blues" },
  { artistName: "Smag På Dig Selv",                scene: "Dragon Nest", style: "Electronic" },
  { artistName: "Colorstar",                       scene: "Dragon Nest", style: "Electronic" },
  { artistName: "Populous",                        scene: "Dragon Nest", style: "Electronic" },
  { artistName: "Nana Benz du Togo",               scene: "Dragon Nest", style: "Afrobeat" },
  { artistName: "Marysia Osu & Kibir La Amlak",   scene: "Dragon Nest", style: "Dub / World" },
  { artistName: "Fidju Kitxora",                   scene: "Dragon Nest", style: "Afrobeat" },
  { artistName: "Spoink",                          scene: "Dragon Nest", style: "Electronic" },
  { artistName: "Kalikamo",                        scene: "Dragon Nest", style: "Tribal / World" },
  { artistName: "$roken $reger",                   scene: "Dragon Nest", style: "Electronic" },
  { artistName: "Heimya",                          scene: "Dragon Nest", style: "Electronic" },
  { artistName: "Enki",                            scene: "Dragon Nest", style: "Tribal / World" },
  { artistName: "Pistamashina",                    scene: "Dragon Nest", style: "Electronic" },
